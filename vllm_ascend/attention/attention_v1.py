...
class AscendAttentionMetadataBuilder(AttentionMetadataBuilder[AscendMetadata]):
    ...
    def build(
        ...
        # Get attn_mask from singleton AttentionMaskBuilder, unless a
        # speculative proposer supplied a method-specific mask.
        attn_mask = common_attn_metadata.custom_attn_mask
